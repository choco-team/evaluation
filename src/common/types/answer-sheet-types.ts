...
export interface AnswerSheetStore extends AnswerSheet {
  ...
  setContent: (index: string | null) => void;
  setTitle: (index: string | null) => void;
...
export interface AnswerSheetState {
  ...
  setAnswerSheet: (answerSheet: AnswerSheetItem[], correctAnswer?: string | number[]) => void;
  addAnswerSheet: (format: QuestionFormat, counts?: number) => void;
  updateAnswerSheet: (id: string, update: Partial<AnswerSheetItem>) => void;
  removeAnswerSheet: (id: string) => void;
  setCorrectAnswer: (id: string, value: string | number) => void;
}
